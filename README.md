# Эксперимент по масштабированию на M4 Monthly

Этот репозиторий содержит воспроизводимый эксперимент для исследовательского вопроса:

Как посерийное масштабирование влияет на качество прогноза у моделей разных классов?
...
- Глобальная древесная модель: `CatBoost`
- Глобальная нейросетевая модель: `PatchTST`
